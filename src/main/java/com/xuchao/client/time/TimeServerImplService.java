...
package com.xuchao.client.time;
 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://impl.service.xuchao.com/", wsdlLocation = "http://localhost:9876/ts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://impl.service.xuchao.com/", "TimeServerImplService");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://impl.service.xuchao.com/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.xuchao.com/", "TimeServerImplPort"), TimeServer.class, features);
    }
