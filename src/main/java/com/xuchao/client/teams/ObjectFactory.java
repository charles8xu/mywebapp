 ...
 * generated in the com.xuchao.client.teams package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTeamResponse_QNAME = new QName("http://service.xuchao.com/", "getTeamResponse");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://service.xuchao.com/", "getTeamsResponse");
    private final static QName _GetTeam_QNAME = new QName("http://service.xuchao.com/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://service.xuchao.com/", "getTeams");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.xuchao.client.teams
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xuchao.com/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xuchao.com/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xuchao.com/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.xuchao.com/", name = "getTeams")
