 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://service.xuchao.com/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://service.xuchao.com/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://service.xuchao.com/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.xuchao.com/", "TeamsPort"), Teams.class, features);
    }
