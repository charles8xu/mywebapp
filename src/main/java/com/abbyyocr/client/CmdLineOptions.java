...
import com.abbyyocr.sdk.ProcessingSettings;
...
public class CmdLineOptions {
     ...
     */
    public static String extractRecognitionLanguage(List<String> args) {
    ...
    public static ProcessingSettings.OutputFormat extractOutputFormat(List<String> args) {
